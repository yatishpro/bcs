...
class Interceptor extends \Mageplaza\Productslider\Block\CategoryId implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductIdsByCategory');
        if (!$pluginInfo) {
            return parent::getProductIdsByCategory();
        } else {
            return $this->___callPlugins('getProductIdsByCategory', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderCategoryIds');
        if (!$pluginInfo) {
            return parent::getSliderCategoryIds();
        } else {
            return $this->___callPlugins('getSliderCategoryIds', func_get_args(), $pluginInfo);
        }
    }
