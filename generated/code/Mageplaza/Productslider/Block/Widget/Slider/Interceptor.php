<?php
namespace Mageplaza\Productslider\Block\Widget\Slider;

/**
 * Interceptor class for @see \Mageplaza\Productslider\Block\Widget\Slider
 */
class Interceptor extends \Mageplaza\Productslider\Block\Widget\Slider implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\Stdlib\DateTime\DateTime $dateTime, \Mageplaza\Productslider\Helper\Data $helperData, \Magento\Framework\App\Http\Context $httpContext, \Mageplaza\Productslider\Model\Config\Source\ProductType $productType, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $dateTime, $helperData, $httpContext, $productType, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayAdditional');
        if (!$pluginInfo) {
            return parent::getDisplayAdditional();
        } else {
            return $this->___callPlugins('getDisplayAdditional', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperData');
        if (!$pluginInfo) {
            return parent::getHelperData();
        } else {
            return $this->___callPlugins('getHelperData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowPrice');
        if (!$pluginInfo) {
            return parent::canShowPrice();
        } else {
            return $this->___callPlugins('canShowPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowReview');
        if (!$pluginInfo) {
            return parent::canShowReview();
        } else {
            return $this->___callPlugins('canShowReview', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowAddToCart');
        if (!$pluginInfo) {
            return parent::canShowAddToCart();
        } else {
            return $this->___callPlugins('canShowAddToCart', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderId');
        if (!$pluginInfo) {
            return parent::getSliderId();
        } else {
            return $this->___callPlugins('getSliderId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getResponsiveConfig');
        if (!$pluginInfo) {
            return parent::getResponsiveConfig();
        } else {
            return $this->___callPlugins('getResponsiveConfig', func_get_args(), $pluginInfo);
        }
    }
