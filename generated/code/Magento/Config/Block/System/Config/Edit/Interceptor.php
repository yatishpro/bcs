...
class Interceptor extends \Magento\Config\Block\System\Config\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSaveButtonHtml()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getSaveButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConfigSearchParamsJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfigSearchParamsJson();
        } else {
            return $this->___callPlugins('getConfigSearchParamsJson', func_get_args(), $pluginInfo);
        }
    }
