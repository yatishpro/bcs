...
class Interceptor extends \Magento\Config\Model\Config implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'extendConfig');
        if (!$pluginInfo) {
            return parent::extendConfig($path, $full, $oldConfig);
        } else {
            return $this->___callPlugins('extendConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDataByPath');
        if (!$pluginInfo) {
            return parent::setDataByPath($path, $value);
        } else {
            return $this->___callPlugins('setDataByPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigDataValue');
        if (!$pluginInfo) {
            return parent::getConfigDataValue($path, $inherit, $configData);
        } else {
            return $this->___callPlugins('getConfigDataValue', func_get_args(), $pluginInfo);
        }
    }
